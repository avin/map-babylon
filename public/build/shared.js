...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"converter","1":"map"}[chunkId]||chunkId) + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _proj4 = __webpack_require__(64);
	...
	var calc = {
	     ...
	     * @returns {number}
	     */
	    getRadian: function getRadian(point, center, radius, initAxis) {
	        var cX = center[initAxis.x];
	        var cY = center[initAxis.y];

	        var vX = point[initAxis.x] - cX;
	        var vY = point[initAxis.y] - cY;
	...
	var color = {
	     ...
	     */
	    hexColorToBabylonColor3: function hexColorToBabylonColor3(hex) {
	...
	var coordinateConverter = {
	     ...
	     */
	    degreesToPixels: function degreesToPixels(lat, lng) {
	        var source = new _proj42['default'].Proj('EPSG:4326'); //source coordinates will be in lnggitude/Latitude, WGS84
	        var dest = new _proj42['default'].Proj('EPSG:3857'); //destination coordinates in meters, global spherical mercators
	        // projection, see http://spatialreference.org/ref/epsg/3785/

	        // transforming point coordinates
	        var p = new _proj42['default'].toPoint([lng, lat]); //any object will do as lngg as it has 'x' and 'y' properties
	        _proj42['default'].transform(source, dest, p); //do the transformation.  x and y are modified in place
	     ...
	     */
	    pixelsToDegrees: function pixelsToDegrees(x, y) {
	        x = x + 4493378;
	        y = y + 7579693;

	        var source = new _proj42['default'].Proj('EPSG:3857');
	        var dest = new _proj42['default'].Proj('EPSG:4326');

	        // transforming point coordinates
	        var p = new _proj42['default'].toPoint([x, y]);
	        _proj42['default'].transform(source, dest, p);
	     ...
	     */
	    gpsToTileCoords: function gpsToTileCoords(lat, lng, zoom) {
	        if (!zoom) {
	            zoom = 16;
	        }
	     ...
	     */
	    tileCoordsToGps: function tileCoordsToGps(x, y, zoom) {
	        if (!zoom) {
	            zoom = 16;
	        }
