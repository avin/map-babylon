...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rendererRenderer = __webpack_require__(66);

	var _rendererRenderer2 = _interopRequireDefault(_rendererRenderer);

	var _uiCatalogCatalog = __webpack_require__(108);

	var _uiCatalogCatalog2 = _interopRequireDefault(_uiCatalogCatalog);

	var _uiModeButtonsModeButtons = __webpack_require__(274);

	var _uiModeButtonsModeButtons2 = _interopRequireDefault(_uiModeButtonsModeButtons);

	var _uiTypeEditorControlTypeEditorControl = __webpack_require__(278);

	var _uiTypeEditorControlTypeEditorControl2 = _interopRequireDefault(_uiTypeEditorControlTypeEditorControl);

	var app = global.app = {};

	$(document).ready(function () {
	    app.renderer = new _rendererRenderer2['default']('map-canvas');
	    app.ui = {
	        catalog: new _uiCatalogCatalog2['default']('catalog'),
	        modeButtons: new _uiModeButtonsModeButtons2['default']('mode-buttons'),
	        typeEditorControl: new _uiTypeEditorControlTypeEditorControl2['default']('type-editor-control')
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataType_catalogJson = __webpack_require__(67);

	var _dataType_catalogJson2 = _interopRequireDefault(_dataType_catalogJson);

	var _dataElement_catalogJson = __webpack_require__(68);

	var _dataElement_catalogJson2 = _interopRequireDefault(_dataElement_catalogJson);

	//Сцены

	var _scenesTypeEditorTypeEditorScene = __webpack_require__(69);

	var _scenesTypeEditorTypeEditorScene2 = _interopRequireDefault(_scenesTypeEditorTypeEditorScene);

	var _scenesMapMapScene = __webpack_require__(105);

	var _scenesMapMapScene2 = _interopRequireDefault(_scenesMapMapScene);

	var _default = (function () {
	    function _default(canvasId) {
	        var _this = this;
	        ...
	        //Сцены
	        this.scenes = {};
	        this.scenes.map = new _scenesMapMapScene2['default'](this.engine);
	        this.scenes.typeEditor = new _scenesTypeEditorTypeEditorScene2['default'](this.engine);
	    ...
	    _createClass(_default, [{
	        key: '_runRenderLoop',
	        value: function _runRenderLoop(scene) {
	        ...
	        key: 'setActiveScene',
	        value: function setActiveScene(sceneName) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SceneWithElements2 = __webpack_require__(70);

	var _SceneWithElements3 = _interopRequireDefault(_SceneWithElements2);

	var _camerasMainCamera = __webpack_require__(80);

	var _camerasMainCamera2 = _interopRequireDefault(_camerasMainCamera);

	var _helperFiguresGrid = __webpack_require__(81);

	var _helperFiguresGrid2 = _interopRequireDefault(_helperFiguresGrid);

	var _controlControl = __webpack_require__(82);

	var _controlControl2 = _interopRequireDefault(_controlControl);

	var _elementsElementDispatcher = __webpack_require__(72);

	var _elementsElementDispatcher2 = _interopRequireDefault(_elementsElementDispatcher);

	//Светильники используем из сцены карты

	var _mapLightsCameraLight = __webpack_require__(103);

	var _mapLightsCameraLight2 = _interopRequireDefault(_mapLightsCameraLight);

	var _mapLightsMainLight = __webpack_require__(104);

	var _mapLightsMainLight2 = _interopRequireDefault(_mapLightsMainLight);
	...
	var _default = (function (_SceneWithElements) {
	    _inherits(_default, _SceneWithElements);

	    function _default(engine) {
	        _classCallCheck(this, _default);

	        _get(Object.getPrototypeOf(_default.prototype), 'constructor', this).call(this, engine);
	        ...
	        this.elementDispatcher = new _elementsElementDispatcher2['default'](this);
	    ...
	    _createClass(_default, [{
	        ...
	        value: function _init() {
	            ...
	            this.grid = new _helperFiguresGrid2['default']('grid', new BABYLON.Vector3.Zero(), this);

	            //Загрузчик ресурсов
	            var loader = new BABYLON.AssetsManager(this);

	            //Загружаем все типовые модели из каталога
	            _.each(this.typeCatalog, function (type) {
	                //Если у типа есть модель
	                var modelName = _.get(type, 'default_model');
	                if (modelName) {
	                    var meshTask = loader.addMeshTask(modelName, '', './assets/models/', modelName + '.obj');
	                    meshTask.onSuccess = function (t) {
	                        //Добавляем модель в единый массив
	                        _this.models[modelName] = BABYLON.Mesh.MergeMeshes(t.loadedMeshes);
	                        //Уменьшаем размер исходной фигуры до нулевого состояния
	                        _this.models[modelName].scaling = new BABYLON.Vector3(0, 0, 0);
	                        _this.models[modelName].material = new BABYLON.StandardMaterial('material', _this);
	                    };
	                }
	            });
	        ...
	        value: function _initCamera() {
	            var mainCameraOptions = {};
	            var mainCamera = new _camerasMainCamera2['default']('ArcRotateCamera', 1, 0.8, 10, new BABYLON.Vector3(0, 0, 0), this, mainCameraOptions);
	        ...
	        value: function _initLights() {
	            var mainLightOptions = {};
	            this.mainLight = new _mapLightsMainLight2['default']('MainLight', new BABYLON.Vector3(-1, -1, 1), this, mainLightOptions);

	            var cameraLightOptions = {};
	            this.cameraLight = new _mapLightsCameraLight2['default']('cameraLight', new BABYLON.Vector3(1, 10, 1), this, cameraLightOptions);
	        }
	    }, {
	        key: 'loadType',
	        value: function loadType(elementType) {
	        ...
	        key: 'appendElement',
	        value: function appendElement(elementType) {
	        ...
	        key: '_appendSingleElement',
	        value: function _appendSingleElement(elementType) {
	            var newElementData = {
	            ...
	            var appendingElement = this.elementDispatcher.createElement(newElementData);
	        ...
	        key: '_appendComplexElement',
	        value: function _appendComplexElement(elementType) {
	            var _this2 = this;

	            var parts = [];

	            //Создаем элемент по каждой части элемента
	            _.each(elementType.parts, function (part) {

	                var partElementType = _this2.typeCatalog[part.type_id];
	                ...
	                var appendingElement = _this2.elementDispatcher.createElement(newElementData);

	                //Делаем привязку к родительскому элементу
	                if (part.parent !== undefined) {
	                    var parentElement = parts[part.parent];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _default = (function (_BABYLON$Scene) {
	    _inherits(_default, _BABYLON$Scene);
	    ...
	    function _default(engine) {
	        ...
	        this.typeCatalog = _.keyBy(_dataType_catalogJson2['default'], '_id');
	        ...
	        this.viewMode = _constants.VIEW_MODES.CLASSIC;
	    ...
	    _createClass(_default, [{
	        ...
	        key: 'setVisibilityOfType',
	        value: function setVisibilityOfType(typeId, visibility) {
	            var typedElements = _.filter(this.elements, { type: { _id: typeId } });
	            _.each(typedElements, function (element) {
	        ...
	        key: 'optimizeFPS',
	        value: function optimizeFPS() {
	            var _this = this;

	            BABYLON.SceneOptimizer.OptimizeAsync(this, BABYLON.SceneOptimizerOptions.ModerateDegradationAllowed(50), function () {
	                console.log('Optimized ModerateDegradation');
	            }, function () {
	                BABYLON.SceneOptimizer.OptimizeAsync(_this, BABYLON.SceneOptimizerOptions.HighDegradationAllowed(40), function () {
	        ...
	        value: function loadTypeModels() {
	            ...
	            _.each(this.typeCatalog, function (type) {
	                ...
	                var modelName = _.get(type, 'default_model');
	                if (modelName) {
	                    var meshTask = _this2.loader.addMeshTask(modelName, '', './assets/models/', modelName + '.obj');
	                    meshTask.onSuccess = function (loaderTask) {
	                        //Добавляем модель в единый массив
	                        _this2.models[modelName] = BABYLON.Mesh.MergeMeshes(loaderTask.loadedMeshes);
	                        //Уменьшаем размер исходной фигуры до нулевого состояния
	                        _this2.models[modelName].scaling = new BABYLON.Vector3(0, 0, 0);
	                        _this2.models[modelName].material = new BABYLON.StandardMaterial('material', _this2);
	                    };
	                }
	            });
	        }
...
/***/ function(module, exports) {
	...
	exports.CONTROL_MODES = CONTROL_MODES;
	var VISIBILITY = {
	    NORMAL: 1,
	    TRANSPARENT: 2,
	    HIDDEN: 3
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _specialSky = __webpack_require__(73);

	var _specialSky2 = _interopRequireDefault(_specialSky);

	var _specialGround = __webpack_require__(75);

	var _specialGround2 = _interopRequireDefault(_specialGround);

	var _lineLine = __webpack_require__(76);

	var _lineLine2 = _interopRequireDefault(_lineLine);

	var _figureFigure = __webpack_require__(78);

	var _figureFigure2 = _interopRequireDefault(_figureFigure);

	var _figureBuilding = __webpack_require__(79);

	var _figureBuilding2 = _interopRequireDefault(_figureBuilding);
	...
	var _default = (function () {
	    ...
	    _createClass(_default, [{
	        ...
	        value: function createElement(elementData) {
	            ...
	            var type = this.getTypeById(elementData.type_id);
	            ...
	            switch (type.kind) {
	                case 'special':
	                    switch (type.code_class) {
	                        case 'sky':
	                            element = new _specialSky2['default'](this.scene, elementData);
	                            break;

	                        case 'ground':
	                            element = new _specialGround2['default'](this.scene, elementData);
	                            break;
	                    }
	                    break;

	                case 'figure':
	                    element = new _figureFigure2['default'](this.scene, elementData);
	                    break;

	                case 'line':
	                    element = new _lineLine2['default'](this.scene, elementData);
	                    break;
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AbstractElement2 = __webpack_require__(74);

	var _AbstractElement3 = _interopRequireDefault(_AbstractElement2);

	var _default = (function (_AbstractElement) {
	    _inherits(_default, _AbstractElement);

	    function _default(scene, elementData) {
	        var options = arguments.length <= 2 || arguments[2] === undefined ? {} : arguments[2];

	        _classCallCheck(this, _default);

	        _get(Object.getPrototypeOf(_default.prototype), 'constructor', this).call(this, scene, elementData);
	    ...
	    _createClass(_default, [{
	        ...
	        key: 'createSphereSkybox',
	        value: function createSphereSkybox() {
	            if (this.mesh) {
	        ...
	        key: 'createBoxSkybox',
	        value: function createBoxSkybox() {
	            if (this.mesh) {
	                this.mesh.dispose(true);
	            }
	        ...
	        key: 'createGradientMaterial',
	        value: function createGradientMaterial() {
	            var material = new BABYLON.ShaderMaterial('gradient', this.scene, './assets/shaders/gradient', {});
	        ...
	        key: 'createTexturedMaterial',
	        value: function createTexturedMaterial() {
	            var material = new BABYLON.StandardMaterial('skyBox', this.scene);
	            material.backFaceCulling = false;
	        ...
	        key: 'setVisibilityNormal',
	        value: function setVisibilityNormal() {
	            _get(Object.getPrototypeOf(_default.prototype), 'setVisibilityNormal', this).call(this);
	        ...
	        key: 'setVisibilityTransparent',
	        value: function setVisibilityTransparent() {
	            _get(Object.getPrototypeOf(_default.prototype), 'setVisibilityTransparent', this).call(this);
	        ...
	        key: 'setVisibilityHidden',
	        value: function setVisibilityHidden() {
	            _get(Object.getPrototypeOf(_default.prototype), 'setVisibilityHidden', this).call(this);
	        ...
	        key: 'colorMountCompatible',
	        value: function colorMountCompatible() {}

	        /**
	         * Подкрасить как несовместимый для монтирования
	         */
	    }, {
	        key: 'colorMountIncompatible',
	        value: function colorMountIncompatible() {}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonHelpers = __webpack_require__(63);

	var _constants = __webpack_require__(71);

	var Abstract = (function () {
	    function Abstract(scene, elementData) {
	    ...
	    _createClass(Abstract, [{
	        ...
	        key: 'setVisibilityDefault',
	        value: function setVisibilityDefault() {
	        ...
	        value: function setVisibility(visibility) {
	            switch (visibility) {
	                case _constants.VISIBILITY.NORMAL:
	                    this.setVisibilityNormal();
	                    break;
	                case _constants.VISIBILITY.TRANSPARENT:
	                    this.setVisibilityTransparent();
	                    break;
	                case _constants.VISIBILITY.HIDDEN:
	        ...
	        key: 'setVisibilityNormal',
	        value: function setVisibilityNormal() {
	            this.visibility = _constants.VISIBILITY.NORMAL;
	        }
	        ...
	        key: 'setVisibilityTransparent',
	        value: function setVisibilityTransparent() {
	            this.visibility = _constants.VISIBILITY.TRANSPARENT;
	        }
	        ...
	        key: 'setVisibilityHidden',
	        value: function setVisibilityHidden() {
	            this.visibility = _constants.VISIBILITY.HIDDEN;
	        }
	        ...
	        key: 'isChildOf',
	        value: function isChildOf(parentElement) {
	            if (this.parent) {
	                if (_.eq(this.parent, parentElement)) {
	                    return true;
	                } else {
	        ...
	        value: function remove() {
	            ...
	            _.remove(this.scene.elements, function (element) {
	        ...
	        key: 'canBeMountedOn',
	        value: function canBeMountedOn(parentElement, position) {
	            if (parentElement) {
	                var parentType = parentElement.getType();
	                var ruleMountIds = _.get(this.type, 'rules.mount', []);
	        ...
	        value: function initMaterials() {
	            var typeStyleColor = _commonHelpers.color.hexColorToBabylonColor3(_.get(this.getType(), 'style.color', '#FFFFFF'));

	            if (this.mesh) {
	                //Если фигура является инстансом - работаем с исходной фигурой
	                var mesh = this.mesh.sourceMesh ? this.mesh.sourceMesh : this.mesh;
	        ...
	        value: function setViewMode(mode) {
	            if (this.mesh) {
	                switch (mode) {
	                    case _constants.VIEW_MODES.CLASSIC:
	                        {

	                            var mesh = this.mesh.sourceMesh || this.mesh;

	                            if (mesh.viewMode !== _constants.VIEW_MODES.CLASSIC) {
	                                //mesh.m
	                            }
	                            ...
	                            mesh.viewMode = _constants.VIEW_MODES.CLASSIC;

	                            break;
	                        }
	                    case _constants.VIEW_MODES.CLASSIC_WITH_EDGES:
	                        {

	                            var sourceMesh = this.mesh.sourceMesh || this.mesh;
	                            var mesh = this.mesh;
	                    ...
	                    case _constants.VIEW_MODES.EDGES:
	                        {
	                    ...
	                    case _constants.VIEW_MODES.DEBUG:
	                        {
	        ...
	        key: 'setLODLevel',
	        value: function setLODLevel(LODLevel) {
	            if (this.mesh) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _default = (function (_AbstractElement) {
	    ...
	    _createClass(_default, [{
	        ...
	        key: 'createSimpleGround',
	        value: function createSimpleGround() {
	            if (this.mesh) {
	                this.mesh.dispose();
	            }
	        ...
	        key: 'createTileGround',
	        value: function createTileGround() {
	            ...
	            var cameraPosition = this.scene.playerCamera.position;
	            var cameraGeoPosition = _commonHelpers.coordinateConverter.pixelsToDegrees(cameraPosition.x, cameraPosition.z);
	            var tileUnderCameraData = _commonHelpers.coordinateConverter.gpsToTileCoords(cameraGeoPosition.lat, cameraGeoPosition.lng, zoom);
	            ...
	            var minTileGeoData = _commonHelpers.coordinateConverter.tileCoordsToGps(tiles.xMin, tiles.yMin + 1, zoom);
	            var maxTileGeoData = _commonHelpers.coordinateConverter.tileCoordsToGps(tiles.xMax + 1, tiles.yMax, zoom);

	            var minTilePixelData = _commonHelpers.coordinateConverter.degreesToPixels(minTileGeoData.lat, minTileGeoData.lng);
	            var maxTilePixelData = _commonHelpers.coordinateConverter.degreesToPixels(maxTileGeoData.lat, maxTileGeoData.lng);

	            var xmin = minTilePixelData.x;
	            var zmin = minTilePixelData.y;
	            var xmax = maxTilePixelData.x;
	            var zmax = maxTilePixelData.y;
	            ...
	            var xTileBase = tiles.xMin;
	            var yTileBase = tiles.yMin;
	            for (var row = 0; row < subdivisions.h; row++) {
	                for (var col = 0; col < subdivisions.w; col++) {
	                    var material = new BABYLON.StandardMaterial('material' + row + '-' + col, this.scene);
	            ...
	            var verticesCount = this.mesh.getTotalVertices();
	            var tileIndicesLength = this.mesh.getIndices().length / (subdivisions.w * subdivisions.h);
	            ...
	            for (var row = 0; row < subdivisions.h; row++) {
	                for (var col = 0; col < subdivisions.w; col++) {
	                    var submesh = new BABYLON.SubMesh(index++, 0, verticesCount, base, tileIndicesLength, this.mesh);
	        ...
	        key: 'createGridGround',
	        value: function createGridGround() {}
	        //TODO
	        ...
	        key: 'setMaterialAlpha',
	        value: function setMaterialAlpha(alpha) {
	            switch (this.options.style) {
	                case 'simple':
	                    {
	                ...
	                case 'tiled':
	                    {
	                        _.each(this.mesh.material.subMaterials, function (subMaterial) {
	...
	var _default = (function (_AbstractElement) {
	    ...
	    _createClass(_default, [{
	        ...
	        value: function _init() {
	            ...
	            var coordinates = _.get(this.data, 'coordinates', []);

	            //Инициализируем фигуры точек изгибов
	            _.each(coordinates, function (coordinate) {
	                var position = new BABYLON.Vector3(coordinate.position.x, coordinate.position.y, coordinate.position.z);
	                var parent = undefined;

	                //Находим родительский элемент по его ID
	                var parentElement = _.find(_this.scene.elements, function (element) {
	                ...
	                _this.initPointMesh(position, parent);
	            });
	        ...
	        value: function drawLine() {
	            ...
	            if (this.getSectionsCount() > 0) {
	                ...
	                var linePositions = _.map(this.pointMeshes, function (pointMesh) {
	        ...
	        key: 'setPointMeshParentElement',
	        value: function setPointMeshParentElement(pointMesh, parentElement) {
	            if (parentElement && !parentElement.isSpecial()) {
	        ...
	        key: 'initPointMesh',
	        value: function initPointMesh(position, parentElement) {
	            var isAbsolutePosition = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];

	            var point = BABYLON.Mesh.CreateSphere('linePoint', 10, this.pointMeshSize, this.scene, false, BABYLON.Mesh.FRONTSIDE);
	        ...
	        key: 'addPoint',
	        value: function addPoint(absolutePosition, parent) {
	        ...
	        key: 'getSectionsCount',
	        value: function getSectionsCount() {
	        ...
	        key: 'showPointMeshes',
	        value: function showPointMeshes() {
	            _.each(this.pointMeshes, function (pointMesh) {
	        ...
	        key: 'hidePointMeshes',
	        value: function hidePointMeshes() {
	            _.each(this.pointMeshes, function (pointMesh) {
	        ...
	        value: function enableHighlight() {
	            if (this.mesh) {
	                ...
	                var highlightMaterial = new BABYLON.StandardMaterial('mat', this.scene);
	        ...
	        value: function updateLinePositions() {
	        ...
	        value: function update() {
	            ...
	            _.each(this.pointMeshes, function (pointMesh) {
	                var scale = BABYLON.Vector3.Distance(_this2.scene.playerCamera.position, pointMesh.getAbsolutePosition()) / 10;
	...
	var _default = (function (_AbstractElement) {
	    ...
	    _createClass(_default, [{
	        ...
	        value: function enableHighlight() {
	            ...
	            _get(Object.getPrototypeOf(_default.prototype), 'enableHighlight', this).call(this);
	        ...
	        value: function disableHighlight() {
	            ...
	            _get(Object.getPrototypeOf(_default.prototype), 'disableHighlight', this).call(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Figure2 = __webpack_require__(78);

	var _Figure3 = _interopRequireDefault(_Figure2);

	var _default = (function (_Figure) {
	    _inherits(_default, _Figure);

	    function _default(Map, elementData) {
	        _classCallCheck(this, _default);

	        _get(Object.getPrototypeOf(_default.prototype), 'constructor', this).call(this, Map, elementData);
	    }
...
/***/ function(module, exports) {
	...
	var _default = (function (_BABYLON$ArcRotateCamera) {
	    _inherits(_default, _BABYLON$ArcRotateCamera);

	    function _default(name, alpha, beta, radius, target, scene, options) {
	        _classCallCheck(this, _default);

	        _get(Object.getPrototypeOf(_default.prototype), "constructor", this).call(this, name, alpha, beta, radius, target, scene);
...
/***/ function(module, exports) {
	...
	var _default = (function () {
	    function _default(name, position, scene) {
	    ...
	    _createClass(_default, [{
	        key: 'createLine',
	        value: function createLine(xRange, yRange, zRange) {
	            var color = arguments.length <= 3 || arguments[3] === undefined ? new BABYLON.Color3(1, 1, 1) : arguments[3];
	            var alpha = arguments.length <= 4 || arguments[4] === undefined ? 1 : arguments[4];

	            var line = BABYLON.Mesh.CreateLines('line', [new BABYLON.Vector3(xRange[0], yRange[0], zRange[0]), new BABYLON.Vector3(xRange[1], yRange[1], zRange[1])], this.scene);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uiModeButtonsActionsActions = __webpack_require__(83);

	var _uiModeButtonsActionsActions2 = _interopRequireDefault(_uiModeButtonsActionsActions);
	...
	var _default = (function () {
	    function _default(scene) {
	        ...
	        this.setMode(_constants.CONTROL_MODES.DRAG);
	    ...
	    _createClass(_default, [{
	        ...
	        value: function _init() {
	            ...
	            this.scene.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnKeyDownTrigger, function (evt) {
	                _.each(_constants.KEY_CODES, function (keyCode, eventName) {
	                    if (evt.sourceEvent.keyCode === keyCode) {
	                        _this.keyStates[eventName] = 1;
	                    }
	                });
	            }));
	            ...
	            this.scene.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnKeyUpTrigger, function (evt) {
	                _.each(_constants.KEY_CODES, function (keyCode, eventName) {
	                    if (evt.sourceEvent.keyCode === keyCode) {
	                        _this.keyStates[eventName] = 0;
	                    }
	                });
	            }));

	            //Переопределяем клавиши управления камерой
	            this.playerCamera.keysDown = [_constants.KEY_CODES.back];
	            this.playerCamera.keysUp = [_constants.KEY_CODES.forward];
	            this.playerCamera.keysLeft = [_constants.KEY_CODES.left];
	            this.playerCamera.keysRight = [_constants.KEY_CODES.right];
	            ...
	            this.scene.registerBeforeRender(function () {
	                ...
	                if (_this.miniCamera) {
	                    _this.miniCamera.orthoLeft = _this.playerCamera.position.x - 500 / 2 * _this.miniCamera.y;
	                    _this.miniCamera.orthoRight = _this.playerCamera.position.x + 500 / 2 * _this.miniCamera.y;
	                    _this.miniCamera.orthoTop = _this.playerCamera.position.z + 500 / 2 * _this.miniCamera.x;
	                    _this.miniCamera.orthoBottom = _this.playerCamera.position.z - 500 / 2 * _this.miniCamera.x;
	                }
	                ...
	                var cameraPositionY = _this.playerCamera.position.y;

	                //Только если камера в режиме управления
	                if (_this.scene.playerCamera._attachedElement) {

	                    //Передвижение камеры вверх
	                    if (_this.keyStates.up == 1) {
	                        cameraPositionY += _this.playerCamera.speed / 20 * _this.playerCamera.accelerator;
	                    }

	                    //Передвижение камеры вниз
	                    if (_this.keyStates.down == 1) {
	                        cameraPositionY -= _this.playerCamera.speed / 20 * _this.playerCamera.accelerator;
	                    }
	                }

	                //Отрицательной высота не может быть - всегда метр над землей
	                _this.playerCamera.position.y = cameraPositionY < 1 ? 1 : cameraPositionY;
	        ...
	        key: '_enableClickInteractionControl',
	        value: function _enableClickInteractionControl() {
	            var _this2 = this;

	            //Отключаем стандартное контексное меню
	            this.scene.getEngine().getRenderingCanvas().addEventListener('contextmenu', function (event) {
	            ...
	            this.scene.onDispose = function () {
	                _this2.scene.getEngine().getRenderingCanvas().removeEventListener('pointerdown', _this2.onPointerDown);
	                _this2.scene.getEngine().getRenderingCanvas().removeEventListener('pointerup', _this2.onPointerUp);
	                _this2.scene.getEngine().getRenderingCanvas().removeEventListener('pointermove', _this2.onPointerMove);
	            };
	        }
	        ...
	        value: function onPointerMove(event) {
	            ...
	            if (this.currentControlMesh && this.currentElement) {
	                ...
	                switch (this.currentControlMesh.name) {
	                    case 'editX':
	                        {
	                            var currentPointOnSupportPlane = this.getPointOnSupportPlane();
	                            if (currentPointOnSupportPlane) {
	                                var diff = currentPointOnSupportPlane.subtract(this.supportPlane.zeroPoint);
	                    ...
	                    case 'arcXY':
	                        {
	                            if (this.supportPlane.startPoint) {
	                                ...
	                                if (currentPointOnSupportPlane) {
	                                    var initAxis = { x: 'x', y: 'y' };
	                                    var rotationRadian = _commonHelpers.calc.getRadian(currentPointOnSupportPlane, this.supportPlane.zeroPoint, this.currentControlMesh.radius, initAxis);
	                                    var startRadian = _commonHelpers.calc.getRadian(this.supportPlane.startPoint, this.supportPlane.zeroPoint, this.currentControlMesh.radius, initAxis);
	                    ...
	                    case 'dragCursor':
	                        {
	                            var pickInfo = scene.pick(scene.pointerX, scene.pointerY, function (mesh) {
	                                ...
	                                if (_.eq(mesh, _this3.currentElement.mesh)) {
	                                    return false;
	                                }

	                                //Не берем дочерные элементы
	                                if (mesh.element) {
	                                    if (mesh.element.isChildOf(_this3.currentElement)) {
	                                        return false;
	                                    }
	                                }

	                                //Только элементы которые не скрыты
	                                if (_.get(mesh, 'element.visibility') !== _constants.VISIBILITY.NORMAL) {
	                                    return false;
	                                }

	                                //Только элементы на которые можно монтировать
	                                return _this3.currentElement.canBeMountedOn(mesh.element);
	                            }, false, camera);
	                    ...
	                    case 'linePoint':
	                        {
	                            ...
	                            if (pickInfo.hit) {
	                                ...
	                                var pickedPoint = pickInfo.pickedPoint.add(pickInfo.getNormal().multiply(new BABYLON.Vector3(0.05, 0.05, 0.05)));
	            ...
	            if (this.mode === _constants.CONTROL_MODES.APPEND) {
	                        ...
	                        case 'figure':
	                            {
	                                 ...
	                                 */
	                                var pickInfo = scene.pick(scene.pointerX, scene.pointerY, function (mesh, foo) {
	                                    //Исключаем положение самой перетаскиваемой
	                                    if (_.eq(mesh, _this3.currentElement.mesh)) {
	                                        return false;
	                                    }
	        ...
	        key: 'onLeftPointerDown',
	        value: function onLeftPointerDown(event) {
	            var _this4 = this;

	            var scene = this.scene;
	            var pickInfo = undefined;
	                    ...
	                    case 'line':
	                        {
	                            ...
	                            pickInfo = scene.pick(scene.pointerX, scene.pointerY, function (mesh) {
	                                return _.includes(_this4.currentElement.pointMeshes, mesh);
	                    ...
	                    case 'figure':
	                        {
	                            ...
	                            pickInfo = scene.pick(scene.pointerX, scene.pointerY, function (mesh) {
	                                return _.includes(_this4.controlMeshes, mesh);
	                            }, false, this.playerCamera);
	        ...
	        key: 'onLeftPointerUp',
	        value: function onLeftPointerUp(event) {
	            var _this5 = this;
	                            ...
	                            case 'line':
	                                {
	                                    ...
	                                    pickInfo = scene.pick(scene.pointerX, scene.pointerY, function (mesh) {
	                                        return _.includes(_this5.currentElement.pointMeshes, mesh);
	                                    }, false, this.playerCamera);
	                                    ...
	                                    pickInfo = scene.pick(scene.pointerX, scene.pointerY, function (mesh) {
	                                        //Только элементы на которые можно монтировать
	                                        return _this5.currentElement.canBeMountedOn(mesh.element);
	                                    }, false, this.playerCamera);
	        ...
	        key: 'onMiddlePointerDown',
	        value: function onMiddlePointerDown(event) {}
	        //
	        ...
	        key: 'onMiddlePointerUp',
	        value: function onMiddlePointerUp(event) {}
	        ...
	        key: 'onRightPointerDown',
	        value: function onRightPointerDown(event) {}
	        //
	        ...
	        key: 'onRightPointerUp',
	        value: function onRightPointerUp(event) {}
	        ...
	        key: 'createSupportPlane',
	        value: function createSupportPlane(parentMesh, rotation) {
	            var _this6 = this;
	            ...
	            this.supportPlane.registerAfterWorldMatrixUpdate(function () {
	                _this6.supportPlane.startPoint = _this6.getPointOnSupportPlane();
	            });
	        }
	        ...
	        key: 'destroySupportPlane',
	        value: function destroySupportPlane() {
	            if (this.supportPlane) {
	        ...
	        key: 'getPointOnSupportPlane',
	        value: function getPointOnSupportPlane() {
	            var _this7 = this;
	            ...
	            var pickinfo = scene.pick(scene.pointerX, scene.pointerY, function (mesh) {
	                return _.eq(mesh, _this7.supportPlane);
	            }, false, camera);
	            if (pickinfo.hit) {
	        ...
	        key: 'unsetCurrentElement',
	        value: function unsetCurrentElement() {
	            if (this.currentElement) {
	        ...
	        key: 'colorMountCompatibleElements',
	        value: function colorMountCompatibleElements() {
	            var _this8 = this;

	            _.each(this.scene.elements, function (element) {
	                if (_this8.currentElement.canBeMountedOn(element)) {
	        ...
	        key: 'unColorMountCompatibleElements',
	        value: function unColorMountCompatibleElements() {
	            _.each(this.scene.elements, function (element) {
	                element.unColor();
	            });
	        }
	        ...
	        key: 'setCurrentControlMesh',
	        value: function setCurrentControlMesh(mesh) {
	        ...
	        key: 'unsetCurrentControlMesh',
	        value: function unsetCurrentControlMesh() {
	                    ...
	                    case 'figure':
	                        {
	                            ...
	                            switch (this.mode) {
	                                case _constants.CONTROL_MODES.MOVE:
	                                    this.showMoveAxis();
	                                    break;
	                                case _constants.CONTROL_MODES.ROTATE:
	                                    this.showRotateAxis();
	                                    break;
	                                case _constants.CONTROL_MODES.DRAG:
	                                    this.showDragCursor();
	                                    break;
	                            }
	                            break;
	        ...
	        value: function hideControl() {
	            _.each(this.controlMeshes, function (mesh) {
	                mesh.dispose();
	            });
	            this.controlMeshes = [];
	        }
	    }, {
	        key: 'showControlAxises',
	        value: function showControlAxises(size) {
	            var scene = this.scene;
	            var mesh = this.currentElement.mesh;
	        ...
	        value: function showMoveAxis() {
	            ...
	            var xBox = BABYLON.Mesh.CreateBox('editX', size / 10, scene);
	            ...
	            var yBox = BABYLON.Mesh.CreateBox('editY', size / 10, scene);
	            ...
	            var zBox = BABYLON.Mesh.CreateBox('editZ', size / 10, scene);
	        ...
	        value: function showRotateAxis() {
	            ...
	            var curvePointsXY = function curvePointsXY(l, t) {
	                var path = [];
	            ...
	            var curvePointsXZ = function curvePointsXZ(l, t) {
	                var path = [];
	                for (var i = 0; i < Math.PI / 2; i += l / t) {
	            ...
	            var curvePointsZY = function curvePointsZY(l, t) {
	                var path = [];
	                for (var i = 0; i < Math.PI / 2; i += l / t) {
	            ...
	            var curveXY = curvePointsXY(1, 100);
	            var curveXZ = curvePointsXZ(1, 100);
	            var curveZY = curvePointsZY(1, 100);

	            var radiusFunction = function radiusFunction() {
	                return size / 15;
	            };
	        ...
	        value: function showDragCursor() {
	            ...
	            //Создаем фигуру
	            var dragCursor = BABYLON.Mesh.CreateSphere('dragCursor', 5, size / 5, scene, false, BABYLON.Mesh.FRONTSIDE);
	            dragCursor.position = mesh.absolutePosition;
	            var dragCursorMaterial = new BABYLON.StandardMaterial('dragCursorMaterial', scene);
	        ...
	        value: function setMode(mode) {
	            ...
	            _uiModeButtonsActionsActions2['default'].setControlMode(mode, false);
	        }
	        ...
	        value: function update() {
	            ...
	            _.each(this.controlMeshes, function (mesh) {
	                var scale = BABYLON.Vector3.Distance(_this9.playerCamera.position, _this9.currentElement.mesh.position) / 15;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reflux = __webpack_require__(84);

	var _reflux2 = _interopRequireDefault(_reflux);

	exports['default'] = _reflux2['default'].createActions(['setControlMode', 'setViewMode']);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(85);

	Reflux.connect = __webpack_require__(98);

	Reflux.connectFilter = __webpack_require__(100);

	Reflux.ListenerMixin = __webpack_require__(99);

	Reflux.listenTo = __webpack_require__(101);

	Reflux.listenToMany = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ActionMethods = __webpack_require__(86);

	Reflux.ListenerMethods = __webpack_require__(87);

	Reflux.PublisherMethods = __webpack_require__(96);

	Reflux.StoreMethods = __webpack_require__(95);

	Reflux.createAction = __webpack_require__(97);

	Reflux.createStore = __webpack_require__(91);

	var maker = __webpack_require__(90).staticJoinCreator;
	...
	var _ = Reflux.utils = __webpack_require__(88);
	...
	Reflux.__keep = __webpack_require__(92);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(88),
	    maker = __webpack_require__(90).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(95),
	        PublisherMethods = __webpack_require__(96),
	        ListenerMethods = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(88),
	    ActionMethods = __webpack_require__(86),
	    PublisherMethods = __webpack_require__(96),
	    Keep = __webpack_require__(92);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListenerMethods = __webpack_require__(87),
	    ListenerMixin = __webpack_require__(99),
	    _ = __webpack_require__(88);
...
/***/ function(module, exports) {
	...
	var _default = (function (_BABYLON$PointLight) {
	    _inherits(_default, _BABYLON$PointLight);

	    function _default(name, direction, scene, options) {
	        _classCallCheck(this, _default);

	        _get(Object.getPrototypeOf(_default.prototype), "constructor", this).call(this, name, direction, scene);
...
/***/ function(module, exports) {
	...
	var _default = (function (_BABYLON$DirectionalLight) {
	    _inherits(_default, _BABYLON$DirectionalLight);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _camerasPlayerCamera = __webpack_require__(106);

	var _camerasPlayerCamera2 = _interopRequireDefault(_camerasPlayerCamera);

	var _camerasMiniMapCamera = __webpack_require__(107);

	var _camerasMiniMapCamera2 = _interopRequireDefault(_camerasMiniMapCamera);

	var _lightsMainLight = __webpack_require__(104);

	var _lightsMainLight2 = _interopRequireDefault(_lightsMainLight);

	var _lightsCameraLight = __webpack_require__(103);

	var _lightsCameraLight2 = _interopRequireDefault(_lightsCameraLight);
	...
	var _default = (function (_SceneWithElements) {
	    ...
	    function _default(engine) {
	        ...
	        //Каталог элементов
	        this.elementCatalog = _.keyBy(_dataElement_catalogJson2['default'], '_id');

	        if (_options2['default'].babylonDebug) {
	            this.showDebug();
	        }
	    ...
	    _createClass(_default, [{
	        ...
	        value: function _init() {
	            ...
	            this.loader.onFinish = function () {
	                ...
	                _this.executeWhenReady(function () {
	                    _this.renderer.setActiveScene(_this.name);
	                });
	        ...
	        key: '_initCameras',
	        value: function _initCameras() {
	            //Главная камера
	            var playerCameraOptions = {};
	            this.playerCamera = new _camerasPlayerCamera2['default']('PlayerCamera', new BABYLON.Vector3(0.0, 0.0, 0.0), this, playerCameraOptions);
	        ...
	        value: function _initLights() {
	            var mainLightOptions = {};
	            this.mainLight = new _lightsMainLight2['default']('MainLight', new BABYLON.Vector3(-1, -1, 1), this, mainLightOptions);

	            var cameraLightOptions = {};
	            this.cameraLight = new _lightsCameraLight2['default']('cameraLight', new BABYLON.Vector3(1, 10, 1), this, cameraLightOptions);
	        }
	        ...
	        value: function _initControl() {
	            this.control = new _controlControl2['default'](this);
	        }
	        ...
	        value: function _initContent() {
	            ...
	            this.beforeRender = function () {
	                var delta = _this2.getEngine().getDeltaTime() / 1000.0;
	                _this2.time += delta;

	                _this2._update(delta, _this2.time);
	            };
	        }
	        ...
	        value: function appendElement(elementType) {
	            ...
	            if (this.control.mode === _constants.CONTROL_MODES.APPEND) {
	                //Убираем текущий элемент для дополнения
	                this.control.currentElement.remove();
	            }

	            this.setControlMode(_constants.CONTROL_MODES.APPEND);
	        ...
	        value: function _appendComplexElement(elementType) {
	            ...
	            _.each(elementType.parts, function (part) {
	                ...
	                var partElementType = _this3.typeCatalog[part.type_id];
	                ...
	                var appendingElement = _this3.elementDispatcher.createElement(newElementData);
...
/***/ function(module, exports) {
	...
	var _default = (function (_BABYLON$FreeCamera) {
	        _inherits(_default, _BABYLON$FreeCamera);

	        function _default(name, position, scene, options) {
	                _classCallCheck(this, _default);

	                _get(Object.getPrototypeOf(_default.prototype), "constructor", this).call(this, name, position, scene);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _default = (function () {
	    function _default(catalogDomId) {
	        ...
	        _.each(_actionsActions2['default'], function (action, actionName) {
	            _this[actionName] = action;
	        });
	    ...
	    _createClass(_default, [{
	        ...
	        value: function _initDom() {
	            _reactDom2['default'].render(_react2['default'].createElement(_componentsCatalog2['default'], null), this.dom);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactIsomorphic = __webpack_require__(259);

	var assign = __webpack_require__(146);
	var deprecated = __webpack_require__(264);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(152);
	var ReactMount = __webpack_require__(135);
	var ReactPerf = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(149);
	var ReactEmptyComponentRegistry = __webpack_require__(151);
	var ReactInstanceHandles = __webpack_require__(152);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClientReactRootIndex = __webpack_require__(190);
	...
	var ReactBrowserComponentMixin = __webpack_require__(197);
	var ReactComponentBrowserEnvironment = __webpack_require__(133);
	...
	var ServerReactRootIndex = __webpack_require__(238);
	...
	function inject() {
	  ...
	  if (process.env.NODE_ENV !== 'production') {
	    ...
	    if (/[?&]react_perf\b/.test(url)) {
	      var ReactDefaultPerf = __webpack_require__(249);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesStore = __webpack_require__(268);

	var _storesStore2 = _interopRequireDefault(_storesStore);

	var _Toggle = __webpack_require__(269);
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    mixins: [_reflux2['default'].connect(_storesStore2['default'], 'data')],
	    render: function render() {
	        var style = { width: this.state.data.options.showCatalog ? 300 : 0 };
	        ...
	        if (this.state.data.options.showCatalog) {
	            content = _react2['default'].createElement(
	                'div',
	                null,
	                _react2['default'].createElement(_Search2['default'], { value: this.state.data.searchValue }),
	                _react2['default'].createElement(_Content2['default'], { catalog: this.state.data.catalog,
	                    parentId: 0, level: 0,
	        ...
	        return _react2['default'].createElement(
	            'div',
	            { style: style },
	            _react2['default'].createElement(_Toggle2['default'], { active: this.state.data.options.showCatalog }),
	            content
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _reflux2['default'].createActions(['toggleCatalog', 'setVisibility', 'toggleShowChildren', 'search', 'appendElement']);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _reflux2['default'].createStore({
	    ...
	    onSearch: function onSearch(searchValue) {
	         ...
	         * @param parentId
	         */
	        var showChildren = function showChildren(parentId) {
	            if (parentId) {
	                _.each(_this.data.catalog, function (catalogItem) {
	        ...
	        _.each(this.data.catalog, function (catalogItem) {
	            if (new RegExp('(' + _this.data.searchValue + ')', 'gi').test(catalogItem.name)) {
	                showChildren(catalogItem.parent_id);
	            }
	        });
	    ...
	    onAppendElement: function onAppendElement(type) {
	     ...
	     */
	    onToggleCatalog: function onToggleCatalog() {
	     ...
	     * @param visibility
	     */
	    onSetVisibility: function onSetVisibility(catalogItemId, visibility) {
	     ...
	     * @param catalogItemId
	     */
	    onToggleShowChildren: function onToggleShowChildren(catalogItemId) {
	        var catalogItem = _.find(this.data.catalog, { _id: catalogItemId });
	     ...
	     */
	    hideAllChildren: function hideAllChildren() {
	        _.each(this.data.catalog, function (catalogItem) {
	     ...
	     */
	    updateCatalogItem: function updateCatalogItem(catalogItemId, catalogItemData) {
	        var typeItem = _.find(this.data.catalog, { _id: catalogItemId });
	     ...
	     */
	    updateCatalog: function updateCatalog(newCatalogData) {
	        if (newCatalogData) {
	            this.data.options = _extends({}, this.data.catalog, { newCatalogData: newCatalogData });
	        }
	        this.trigger(this.data);
	    },
	     ...
	     */
	    updateOptions: function updateOptions(newOptionsData) {
	        if (newOptionsData) {
	            this.data.options = _extends({}, this.data.options, newOptionsData);
	        }
	        this.trigger(this.data);
	    },
	    ...
	    getInitialState: function getInitialState() {
	        ...
	        _.each(_dataType_catalogJson2['default'], function (type) {
	            type.visibility = type.visibility || _constants.VISIBILITY.NORMAL;
	        });

	        this.data = {
	            catalog: _dataType_catalogJson2['default'],
	            searchValue: '',
	            options: {
	                showCatalog: true
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    handleClick: function handleClick() {
	        _actionsActions2['default'].toggleCatalog();
	    },
	    render: function render() {
	        var currentIcon = this.props.active ? 'fa-chevron-left' : 'fa-chevron-right';
	        return _react2['default'].createElement(
	            'div',
	            { className: 'catalog-toggle', onClick: this.handleClick },
	            _react2['default'].createElement('span', { className: 'fa ' + currentIcon })
	        );
	    }
	});
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CatalogItem = __webpack_require__(271);
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        var catalogItems = _.map(this.props.catalog, function (catalogItem, key) {
	            var haveChildren = !!_.find(_this.props.catalog, { parent_id: catalogItem._id });
	            if (catalogItem.parent_id === _this.props.parentId) {
	                return _react2['default'].createElement(_CatalogItem2['default'], { item: catalogItem, key: key,
	                    haveChildren: haveChildren, catalog: _this.props.catalog,
	                    level: _this.props.level, searchValue: _this.props.searchValue });
	            }
	        });

	        var style = { backgroundColor: 'rgba(0, 0, 0, ' + this.props.level / 50 + ')' };
	        return _react2['default'].createElement(
	            'div',
	            { className: 'catalog-content', style: style },
	            catalogItems
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Visibility = __webpack_require__(272);
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    handleShowChildren: function handleShowChildren() {
	        _actionsActions2['default'].toggleShowChildren(this.props.item._id);
	    },
	    _highlightQuery: function _highlightQuery(name, query) {
	        var regex = new RegExp('(' + query + ')', 'gi');
	        return '<span>' + name.replace(regex, '<strong>$1</strong>') + '</span>';
	    },
	    handleAppendElement: function handleAppendElement() {
	        _actionsActions2['default'].appendElement(this.props.item);
	    },
	    ...
	    render: function render() {
	        ...
	        if (this.props.item.create_enable) {
	            addButton = _react2['default'].createElement(
	                'button',
	                { className: 'btn btn-xs btn-default', onClick: this.handleAppendElement },
	        ...
	        if (_.includes(['complex', 'figure'], this.props.item.kind)) {
	            editButton = _react2['default'].createElement(
	                'button',
	                { className: 'btn btn-xs btn-default btn-show-complex-editor', onClick: this.handleEditType },
	                _react2['default'].createElement('i', { className: 'fa fa-pencil' })
	            );
	        }

	        var isVisible = !_.get(this.props.item, 'is_hidden', false);

	        var showChildren = undefined;
	        ...
	        if (this.props.haveChildren && this.props.item.show_children) {
	            children = _react2['default'].createElement(_Content2['default'], { catalog: this.props.catalog, parentId: this.props.item._id,
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'col-xs-1', onClick: this.handleShowChildren },
	                    showChildren
	                ),
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'col-xs-8', onClick: this.handleShowChildren },
	                    _react2['default'].createElement('span', { dangerouslySetInnerHTML: { __html: this._highlightQuery(this.props.item.name, this.props.searchValue) } }),
	                    ' ',
	                    editButton
	                ),
	                _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'col-xs-1' },
	                    _react2['default'].createElement(_Visibility2['default'], { item: this.props.item })
	                )
	            ),
	            _react2['default'].createElement(
	                'div',
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    changeVisibility: function changeVisibility() {
	        switch (this.props.item.visibility) {
	            case _constants.VISIBILITY.NORMAL:
	                _actionsActions2['default'].setVisibility(this.props.item._id, _constants.VISIBILITY.TRANSPARENT);
	                break;
	            case _constants.VISIBILITY.TRANSPARENT:
	                _actionsActions2['default'].setVisibility(this.props.item._id, _constants.VISIBILITY.HIDDEN);
	                break;
	            case _constants.VISIBILITY.HIDDEN:
	                _actionsActions2['default'].setVisibility(this.props.item._id, _constants.VISIBILITY.NORMAL);
	                break;
	        }
	    },
	    render: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    handleKeyPress: function handleKeyPress(event) {
	        if (event.key === 'Enter') {
	            _actionsActions2['default'].search(this.state.value);
	        }
	    },
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('input', { type: 'text', className: 'form-control', placeholder: 'Найти...', value: this.state.value,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesStore = __webpack_require__(275);

	var _storesStore2 = _interopRequireDefault(_storesStore);

	var _actionsActions = __webpack_require__(83);

	var _actionsActions2 = _interopRequireDefault(_actionsActions);

	var _componentsButtonsBox = __webpack_require__(276);

	var _componentsButtonsBox2 = _interopRequireDefault(_componentsButtonsBox);

	var _default = (function () {
	    function _default(ModeButtonsDomId) {
	        var _this = this;
	    ...
	    _createClass(_default, [{
	        key: '_initDom',
	        value: function _initDom() {
	            _reactDom2['default'].render(_react2['default'].createElement(_componentsButtonsBox2['default'], null), this.dom);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _reflux2['default'].createStore({
	     ...
	     */
	    onSetControlMode: function onSetControlMode(controlMode) {
	        var action = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
	     ...
	     */
	    onSetViewMode: function onSetViewMode(viewMode) {
	        var action = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];

	        if (action) {
	            _.each(window.app.renderer.scenes, function (scene) {
	    ...
	    getInitialState: function getInitialState() {
	        this.data = {
	            controlMode: _constants.CONTROL_MODES.MOVE,
	            viewMode: _constants.VIEW_MODES.CLASSIC
	        };
	        return this.data;
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ButtonsGroup = __webpack_require__(277);
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        var groupControlMode = [{
	            name: 'Перемещение по осям',
	            icon: 'icon_Cascade_Axis_40x.png',
	            value: _constants.CONTROL_MODES.MOVE,
	            action: _actionsActions2['default']['setControlMode']
	        }, {
	            name: 'Вращение',
	            icon: 'icon_rotateb_40x.png',
	            value: _constants.CONTROL_MODES.ROTATE,
	            action: _actionsActions2['default']['setControlMode']
	        }, {
	            name: 'Drag\'n\'Drop',
	            icon: 'icon_BlueprintEditor_Components_40x.png',
	            value: _constants.CONTROL_MODES.DRAG,
	            action: _actionsActions2['default']['setControlMode']
	        }];
	        ...
	        var groupViewMode = [{
	            ...
	            value: _constants.VIEW_MODES.CLASSIC,
	            action: _actionsActions2['default']['setViewMode']
	        }, {
	            name: 'Тела с гранями',
	            icon: 'icon_Mode_BSP_40x.png',
	            value: _constants.VIEW_MODES.CLASSIC_WITH_EDGES,
	            action: _actionsActions2['default']['setViewMode']
	        }, {
	            name: 'Только грани',
	            icon: 'icon_bspmode_40x.png',
	            value: _constants.VIEW_MODES.EDGES,
	            action: _actionsActions2['default']['setViewMode']
	        }, {
	            name: 'Отладочные грани',
	            icon: 'icon_PhAT_NewBody_40x.png',
	            value: _constants.VIEW_MODES.DEBUG,
	            action: _actionsActions2['default']['setViewMode']
	        }];
	        ...
	        return _react2['default'].createElement(
	            'div',
	            { className: 'ui-box' },
	            _react2['default'].createElement(_ButtonsGroup2['default'], { data: groupControlMode, active: this.state.data.controlMode }),
	            _react2['default'].createElement(_ButtonsGroup2['default'], { data: groupViewMode, active: this.state.data.viewMode })
	        );
	    }
	});
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        var buttons = _.map(this.props.data, function (item, key) {
	            var active = _this.props.active === item.value;
	            return _react2['default'].createElement(
	                'button',
	                { className: 'btn ' + (active ? 'btn-warning' : 'btn-default'),
	                    key: key, title: item.name, onClick: item.action.bind(_this, item.value) },
	                _react2['default'].createElement('img', { src: './assets/icons/' + item.icon, width: '24px', height: '24px' })
	            );
	        });
	        return _react2['default'].createElement(
	            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesStore = __webpack_require__(279);

	var _storesStore2 = _interopRequireDefault(_storesStore);

	var _actionsActions = __webpack_require__(280);

	var _actionsActions2 = _interopRequireDefault(_actionsActions);

	var _componentsButtonsBox = __webpack_require__(281);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ButtonsGroup = __webpack_require__(282);
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            'div',
	            { className: 'ui-box' },
	            _react2['default'].createElement(_ButtonsGroup2['default'], null)
	        );
	    }
	});
	module.exports = exports['default'];
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'button',
	                { className: 'btn btn-default', onClick: this.handleClickClose },
	                'Закрыть'
	            )
	        );
	    }
